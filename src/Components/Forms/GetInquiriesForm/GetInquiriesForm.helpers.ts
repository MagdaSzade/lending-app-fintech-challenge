...
export const getInquiriesValidation = (values: GetInquiryFormInterface) => {
    ...
    if (values.maxAmount < values.minAmount) {
        ...
        errors.minAmount = 'Maksymalna kwota pożyczki musi być większa niż minimalna.';
    }
    if (values.maxLoanDuration < values.minLoanDuration) {
        ...
        errors.minLoanDuration = 'Maksymalny czas pożyczki musi być większy niż minimalny.';
    }
